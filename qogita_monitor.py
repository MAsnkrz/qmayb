"""
Qogita Maybelline Monitor — Catalog Download API version
Monitors https://www.qogita.com/brands/maybelline/

Uses Qogita's official public Buyer API endpoint:
  GET /variants/search/download/?brand_name=Maybelline
...
BRAND_NAME       = "Maybelline"        # adjust if fallback attempts below are needed
BRAND_NAME_FALLBACKS = ["MAYBELLINE", "Maybelline New York"]
BRAND_PAGE_URL   = "https://www.qogita.com/brands/maybelline/"
SNAPSHOT_FILE    = "snapshot_qogita.json"
BASELINE_FLAG    = "baseline_done.txt"
...
def main():
    print("=" * 55)
    print("  Qogita Maybelline Monitor (Catalog Download API)")
